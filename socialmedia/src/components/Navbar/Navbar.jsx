...
function Navbar() {
  return (
    <div className="nav sticky top-0 shadow px-3 py-2 mt-5 top-0 flex justify-between h-15 bg-white">
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" className=" w-8  h-8">
  ...
  <path fillRule="evenodd" d="M9.965 11.026a5 5 0 1 1 1.06-1.06l2.755 2.754a.75.75 0 1 1-1.06 1.06l-2.755-2.754ZM10.5 7a3.5 3.5 0 1 1-7 0 3.5 3.5 0 0 1 7 0Z" clipRule="evenodd" />
                ...
                <input  className="  w-96 rounded-xl  px-4 p-2" type="text" placeholder="search" />          
                </div>    
